...
<head>
    ...
    <title>Administrator Rashad	</title>
    <!-- Bootstrap Styles-->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="usersetting.php"><i class="fa fa-user fa-fw"></i> Admin Manager</a>
                        </li>
                        <li><a href="settings.php"><i class="fa fa-gear fa-fw"></i> Available Room's</a>
                        </li>
                        <li class="divider"></li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> History & Payment </a>
                    </li>
                    <li>
